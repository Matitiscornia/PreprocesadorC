...
# ¿Como Utilizarlo?
 ...
 Para probar su funcionamiento escribimos "preprocess.exe < Test.c", de esta forma le pasamos como entrada el archivo de prueba, también puede utilizarlo con cualquier texto que tenga sintaxis del lenguaje C.
